  ...
  return (
    <main className="flex flex-col  lg:mb-40 mb-20  ">
        <div className="flex justify-center py-10 items-center w-full">
          ...
          <div className="flex max-sm:flex-col items-center lg:items-end ">
          ...
          <h3 className="font-bold underline text-black text-sm pb-2">¿En qué estado se encuentra tu pedido de oración?</h3>
          ...
          <h3 className=" pt-2 text-[0.7rem] text-[#1C1D1E]/70 text-xs">HACE CLICK PARA INGRESAR TU ACTUALIZACIÓN</h3>
            ...
            <span className="lg:h-[520px] max-sm:w-72 lg:border-l-4 max-sm:border-t-[1px] max-sm:mt-16 max-sm:mb-9 lg:mt-28 border-black"></span>
            <div className="flex flex-col text-center lg:w-1/2">
