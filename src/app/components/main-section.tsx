  ...
  return (
    <main className="flex flex-col gap-24 my-[100px]">
        <div className="flex justify-center items-center w-full">
          <img src="./arrow-down.webp" alt="Imagen de flecha para abajo" />
          </div>
          <div className="flex justify-around items-center">
            ...
            <h2 className="text-[88px] leading-none w-9/12 m-auto mt-0">QUEREMOS ORAR POR VOS!</h2>
              ...
              <button onClick={() => { setReason(REASONS.REQUEST) }} className="py-7 px-8 bg-black  m-auto text-white rounded-[90px] text-4xl">PEDIDO DE ORACION</button>
            ...
            <div className="flex flex-col text-center gap-12">
              ...
              <button onClick={() => { setReason(REASONS.GRATITUDE) }} className="py-7 px-8 bg-black  m-auto text-white rounded-[90px] text-4xl">AGRADECIMIENTO</button>
              <p className="font-bold -mt-4">HACE CLICK PARA INGRESAR TU AGRADECIMIENTO</p>
            </div>
          </div>
      </main>
  )
