        ...
        <div className="flex justify-center items-center w-full">
          ...
          <div className="flex max-sm:flex-col gap-16 justify-around items-center">
            ...
            <h2 className="lg:text-[5.5rem] text-4xl leading-none w-8/12 m-auto mt-0">QUEREMOS ORAR POR VOS!</h2>
              ...
              <button onClick={() => { setReason(REASONS.REQUEST) }} className="py-3 bg-black w-[65%] m-auto text-white rounded-[90px] lg:text-4xl text-2xl">PEDIDO DE ORACION</button>
              <h3 className="-mt-4 max-sm:text-xs text-[#1C1D1E]/70">HACE CLICK PARA INGRESAR TU PEDIDO</h3>
            </div>
            <span className="lg:h-[580px] w-72 justify-center lg:border-l-4 border-t-[1px] border-black"></span>
            <div className="flex flex-col text-center gap-12">
              ...
              <button onClick={() => { setReason(REASONS.GRATITUDE) }} className="py-3 bg-black w-[65%] m-auto text-white rounded-[90px] lg:text-4xl text-2xl">AGRADECIMIENTO</button>
