        ...
        <div className="flex justify-center py-10 items-center w-full">
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-end ">
            ...
            <h2 className=" lg:text-[5.5rem] text-[2.5rem] leading-[0.85] w-10/12 lg:mb-11 mb-5 m-auto mt-0">QUEREMOS <br/> ORAR CON VOS</h2>
              ...
              <button onClick={() => { setReason(REASONS.REQUEST) }} className="py-3   lg:py-7 px-2 bg-[#1C1D1E] w-4/5 lg:w-2/4  m-auto text-white rounded-[90px] lg:text-4xl text-2xl tracking-wide">PEDIDOS DE ORACIÓN</button>
          ...
          <h3 className="font-bold underline text-black text-[0.8rem] pb-2 w-full">¿En qué estado se encuentra tu pedido de oración?</h3>
          ...
          <h3 className=" pt-2 text-[0.7rem] text-[#1C1D1E]/70 text-xs">HACE CLICK PARA INGRESAR TU ACTUALIZACIÓN</h3>
            ...
            <div className="flex flex-col text-center lg:w-1/2">
              ...
              <button onClick={() => { setReason(REASONS.GRATITUDE) }} className="py-3 lg:py-7 px-2  bg-[#1C1D1E] w-4/5 lg:w-2/4  m-auto text-white rounded-[90px] lg:text-4xl tracking-wide text-2xl">TESTIMONIOS</button>
